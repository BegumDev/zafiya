"""
Django settings for zafiya project.
...
INSTALLED_APPS = [
    ...
    'allauth',
    'allauth.account',  # used for logging in and out
    'allauth.socialaccount',  # used for logging via social accounts
    'home',
    'products',
    'bag',
    # 'checkout',
    'checkout2',  # 2nd checkout attempt
    # 'profiles',
    'blog',
...
WSGI_APPLICATION = 'zafiya.wsgi.application'
...
# comment these out to go back to dev mode
if 'USE_AWS' in os.environ:
    ...
    # Bucket config
    AWS_STORAGE_BUCKET_NAME = 'zafiya'
...
DEFAULT_FROM_EMAIL = 'zafiya@example.com'
# else:
